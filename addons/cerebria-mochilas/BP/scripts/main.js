...
const custom_content = {
	// MODIFICADO respecto al Chest-UI original: se registran las mochilas para que
	// se dibujen dentro del cofre (aparecen en el inventario del jugador, que la
	// UI muestra debajo de la rejilla). Referenciar la ruta de textura en vez de
	// un id vanilla pierde el brillo de encantado, que aqui no aplica.
	'cerebria:mochila_cuero': {
		texture: 'textures/items/mochila_cuero',
		type: 'item'
	},
	'cerebria:mochila_hierro': {
		texture: 'textures/items/mochila_hierro',
		type: 'item'
	},
	'cerebria:mochila_netherita': {
		texture: 'textures/items/mochila_netherita',
		type: 'item'
	},
};
